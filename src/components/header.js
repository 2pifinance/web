            ...
            <div className="fixed-bottom pb-4">
              <div className="container">
                ...
                <div className="d-flex justify-content-center pb-2">
                  <div className="mx-4">
                    <Link href="https://twitter.com/2piFinance">
                      <a className="h4 text-white text-decoration-none" target="_blank" rel="noreferrer" title="Tweet us!">
                  ...
                  <div className="mx-4">
                    <Link href="https://discord.com/invite/h8VG2XcwvT">
                      <a className="h4 text-white text-decoration-none" target="_blank" rel="noreferrer" title="Talk with us!">
                  ...
                  <div className="mx-4">
                    <Link href="https://2pifinance.medium.com">
                      <a className="h4 text-white text-decoration-none" target="_blank" rel="noreferrer" title="Read us!">
